        ...
        children: [
          ...
          Row(
            children: [
              ...
              InkWell(
                onTap: ()async {
                  var whatsappUrl = "https://api.whatsapp.com/send?phone=+201022952483";
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      Image.asset('assets/images/1216841.png',width: 25,height: 20,color: Colors.white,),
                      SizedBox(
                        width: 3.w,
                      ),
                      Text(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(Icons.favorite_outline,color: HexColor('E3319D'),),
                Spacer(),
                InkWell(
                  onTap: ()async {
                    var whatsappUrl = "https://api.whatsapp.com/send?phone=+201022952483";
