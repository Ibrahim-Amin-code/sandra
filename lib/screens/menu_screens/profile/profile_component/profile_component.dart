...
import 'package:sandra_app/screens/menu_screens/profile/get_profile_cubit/cubit.dart';
import 'package:sandra_app/screens/menu_screens/profile/update_profile_cubit/update_profile_states.dart';
import 'package:sandra_app/screens/menu_screens/profile/update_profile_cubit/update_profle_cubit.dart';
...
//                           fontSize: 16.0);
//                       Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=> LayoutScreen(index: 4)), (route) => false);
//                     }else{
//                       Fluttertoast.showToast(
//                           msg: UpdateProfileCubit.get(context).data['msg'].toString(),
//                           toastLength: Toast.LENGTH_LONG,
...
//                         shrinkWrap: true,
//                         children: [
//                           Text(LocaleKeys.Username.tr(),style: TextStyle(
//                               fontSize: 14,
//                               color: HexColor('#333333'),
...
//
//                           SizedBox(height: 20,),
//                           Text(LocaleKeys.Phone.tr(),style: TextStyle(
//                               fontSize: 14,
//                               color: HexColor('#333333'),
//                               fontWeight: FontWeight.w600,
//                               fontFamily: 'OpenSans'
...
//                           InkWell(
//                             onTap: (){
//                               UpdateProfileCubit.get(context).updateProfile(name: usernameController.text, mobile: mobileController.text);
//                             },
//                             child: Center(
//                               child:  Container(
...
Widget textFormField({
  ...
  required bool obscureText,
    ...
    decoration: InputDecoration(
      ...
      enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: HexColor("#E6E6E6")),),
      focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: HexColor("#E6E6E6")),),
      border: OutlineInputBorder(borderSide: BorderSide(color: HexColor("#E6E6E6")),),
    ));
