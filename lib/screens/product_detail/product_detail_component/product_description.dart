    ...
    List<Widget> screens = [
      ...
      Column(
        children: [
          ...
          detailItem(color: "#F5F6F8", txt1: "Band colousre", txt2: "Buckle / clasp"),
          detailItem(color: "#FFFFFF", txt1: "Bnad Material", txt2: "Stanless"),
          detailItem(color: "#F5F6F8", txt1: "Model number", txt2: "LTP-1274D-7ADF"),
        ],
      ),
      const Center(
  ...
  AnimatedContainer buildDot({required int index}) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
          ...
          color:
              currentIndex == index ? HexColor("#E3319D") : Colors.transparent),
      child: InkWell(
          onTap: () {
